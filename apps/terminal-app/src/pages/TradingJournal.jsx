...
export default function TradingJournal() {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4 md:px-6 max-w-[1600px] mx-auto bg-transparent" dir={language === 'he' ? 'rtl' : 'ltr'}>
      {/* AI Insights Button */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
          ...
          <GlassCard className={`lg:col-span-1 p-6 relative overflow-hidden flex flex-col items-center justify-center text-center ${streak.type === 'winning' ? 'bg-emerald-900/10 border-emerald-500/20' : streak.type === 'losing' ? 'bg-rose-900/10 border-rose-500/20' : 'bg-white/5 border-white/10'}`}>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full">
              <div className={`w-16 h-16 rounded-full ${streak.type === 'winning' ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400' : streak.type === 'losing' ? 'bg-rose-500/10 border-rose-500/20 text-rose-400' : 'bg-white/10 border-white/20 text-slate-400'} flex items-center justify-center mb-4 border shadow-[0_0_20px_rgba(16,185,129,0.2)]`}>
                <Zap className="w-8 h-8 fill-current" />
              </div>
              <div className={`text-sm font-medium ${streak.type === 'winning' ? 'text-emerald-200' : streak.type === 'losing' ? 'text-rose-200' : 'text-slate-300'} mb-1`}>
              ...
              <div className={`text-xs ${streak.type === 'winning' ? 'text-emerald-400/60' : streak.type === 'losing' ? 'text-rose-400/60' : 'text-slate-500'} uppercase tracking-wider`}>Trades</div>
              <div className="mt-auto pt-6 border-t border-white/10 w-full px-4">
