...
import {
    ...
    Zap, Activity, Shield, AlertTriangle, ArrowRight,
    Crosshair, Check, BarChart2, Upload, FileText
} from 'lucide-react';
...
const FEATURE_BOXES = [
    { title: "AI Market Analyzer", desc: "Deep-scan structural anomalies, liquidity sweeps, and sentiment shifts in real-time.", icon: <Radar />, targetId: "analyzer" },
    { title: "Position Engine", desc: "Dynamic risk calculator outputs optimal position size based on volatility.", icon: <Calculator />, targetId: "calculator" },
    { title: "Smart Journal", desc: "Automated trade logging with AI tagging. Upload CSVs in seconds.", icon: <BookOpen />, targetId: "journal" },
    { title: "AI Trading Coach", desc: "Personalized neural network analyzing psychological leaks.", icon: <Brain />, targetId: "coach" },
    { title: "Performance Dashboard", desc: "Institutional-grade analytics tracking equity curve and expectancy.", icon: <LayoutDashboard />, targetId: "dashboard" },
];

const FeatureBox = ({ item, index }) => (
    <motion.div
    ...
    >
        <GlassCard
            className="p-6 h-full flex flex-col items-start text-left group border-white/10 bg-white/5 hover:bg-white/10 backdrop-blur-2xl transition-all duration-300 hover:border-white/20 hover:scale-[1.02]"
            glowColor="rgba(255, 255, 255, 0.2)"
        >
            <div className="mb-4 w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white group-hover:bg-white/10 transition-all duration-300 shadow-inner">
    ...
    return (
        <div className="relative min-h-screen">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32">
                ...
                <section id="analyzer" className="mb-40 pt-20">
                ...
                <section id="calculator" className="mb-40 pt-20">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                            initial={{ opacity: 0, scale: 0.9 }}
                            whileInView={{ opacity: 1, scale: 1 }}
                ...
                {/* 5. DEEP DIVE 3: COACH */}
                <section id="coach" className="mb-40 pt-20">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                            initial={{ opacity: 0, x: -30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                ...
                <section id="journal" className="mb-40 pt-20">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                            initial={{ opacity: 0, scale: 0.9 }}
                            whileInView={{ opacity: 1, scale: 1 }}
                ...
                <section id="dashboard" className="mb-20 pt-20">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                            initial={{ opacity: 0, x: -30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                    <Button
                                        variant="primary"
                                        size="lg"
                                        className="min-w-[180px] shadow-[0_0_30px_rgba(79,70,229,0.3)] hover:shadow-[0_0_50px_rgba(79,70,229,0.5)] border-indigo-500/50"
