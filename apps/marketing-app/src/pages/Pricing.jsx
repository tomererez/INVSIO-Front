    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className={`p-2 rounded-full border transition-all duration-300 flex items-center justify-center ${isOpen
...
export default function Pricing() {
    ...
    return (
        <div className="relative min-h-screen pt-32 pb-20">
            ...
            {/* Background Ambience - Opposite of About page */}
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute bottom-0 left-0 w-[800px] h-[800px] bg-indigo-600/20 rounded-full blur-[100px] mix-blend-screen translate-x-[-50%] translate-y-[50%] opacity-20" />
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-cyan-500/20 rounded-full blur-[100px] mix-blend-screen translate-x-[50%] translate-y-[-50%] opacity-20" />
            </div>
