...
const SectionHeading: React.FC<SectionHeadingProps> = ({ children, align = 'center' }) => (
  <motion.div 
...
export const About: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-void relative overflow-hidden">
      ...
      {/* 4. SIGNAL VS NOISE (The Comparison) */}
      <section className="py-32 px-6 relative">
          <div className="max-w-6xl mx-auto">
             <div className="grid md:grid-cols-2 gap-8 relative items-start">
                 ...
                 {/* The Gambler */}
                 <GlassCard className="p-10 border-rose-500/20 bg-rose-950/5 relative overflow-hidden h-fit" hoverEffect={false}>
                     ...
                     <div className="relative z-10">
                        ...
                        <ul className="space-y-6">
                            {[
                                "Chases green candles (FOMO)",
                                "No stop loss ('it will come back')",
                                "Uses 50x leverage on gut feeling",
                                "Stares at the 1m chart all day",
                                "Liquidation is a weekly event"
                            ].map((item, i) => (
                 ...
                 {/* The Professional */}
                 <GlassCard className="p-10 border-emerald-500/20 bg-emerald-950/5 relative overflow-hidden h-fit" hoverEffect={false}>
                     <div className="absolute -left-10 -top-10 w-40 h-40 bg-emerald-500/10 rounded-full blur-[50px]" />
                     <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-8">
                            <Check className="w-8 h-8 text-emerald-500" />
                            <h3 className="text-2xl font-light text-white">The Professional</h3>
                        </div>
                        <ul className="space-y-6">
                            {[
                                "Waits for liquidity sweeps",
                                "Pre-defined risk per trade (1-2%)",
                                "Trades based on data, not emotion",
                                "Focuses on High Time Frame structure",
