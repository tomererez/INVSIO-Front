...
const ContactOption = ({ icon, title, desc, action, delay }: any) => (
  <motion.div
...
const InputField = ({ label, type = "text", placeholder, rows, value, onChange }: any) => (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div className="space-y-6">
                ...
                <motion.div 
                    ...
                    className="p-6 rounded-2xl border border-emerald-500/20 bg-emerald-900/5 flex items-center justify-between"
                >
